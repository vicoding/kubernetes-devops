...
export MASTER=${MASTER:-"hyperchain@172.16.167.61"}
export MASTER_IP=${MASTER#*@}

# Define all your minion nodes,
# And separated with blank space like <user_1@ip_1> <user_2@ip_2> <user_3@ip_3>.
# The user should have sudo privilege
export NODES=${NODES:-"hyperchain@172.16.167.65"}
...
export PACKAGE_PATH=${PACKAGE_PATH:-"/home/hyperchain/dashboard_packages"}
